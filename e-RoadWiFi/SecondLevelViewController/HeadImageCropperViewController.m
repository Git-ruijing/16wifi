//
//  HeadImageCropperViewController.m
//  e-RoadWiFi
//
...
@interface HeadImageCropperViewController ()

@end

@implementation HeadImageCropperViewController
...
- (void)initView {
    ...
    self.ratioView.layer.shadowRadius = 2.0;
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(HeadImageCropperDelegate)]) {
