...
/** 友盟模块启动
 ...
 如果无法在application:didFinishLaunchingWithOptions:里添加友盟的[MobClick startWithAppkey:]方法，
 App的启动事件可能会无法监听，此时需要手动调用[MobClick startSession:nil]来启动友盟的session。
 上述情况通常发生在某些第三方框架生成的app里，普通app使用不到.
 */
