...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        messageBackgroundView.image = [[UIImage imageNamed:@"talkright.png"] stretchableImageWithLeftCapWidth:10 topCapHeight:10];
...
//    CGSize labelSize = [self.textLabel.text sizeWithFont:[UIFon systemFontOfSize:14.0f] constrainedToSize:CGSizeMake(226, MAXFLOAT) lineBreakMode:NSLineBreakByWordWrapping];
