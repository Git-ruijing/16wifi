...
//    pathAnimation.fromValue = (__bridge id)[_apath CGPath];
//    pathAnimation.toValue = (__bridge id)[_apath CGPath];
//    pathAnimation.duration = 1.9f;
//    [_shapelayer addAnimation:pathAnimation forKey:@"pathAnimation"];
//    
//    
