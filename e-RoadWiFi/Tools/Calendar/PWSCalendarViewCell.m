...
//       CGFloat itemWidth = floorf((self.bounds.size.width-18) / 7);
    layout.itemSize = CGSizeMake(itemWidth, space);
    ...
    m_collection_view.backgroundColor=[UIColor whiteColor];
...
//    CGFloat itemWidth = floorf((self.bounds.size.width-18) / 7);
       CGFloat itemWidth = floorf(CGRectGetWidth(self.bounds) / 7);
    return CGSizeMake(itemWidth, space);
}
