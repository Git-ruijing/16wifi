...
const float PWSCalendarTimeHeadViewHeight = 30;
...
- (id) initWithFrame:(CGRect)frame CalendarType:(enCalendarViewType)pType
{
    ...
    NSLog(@"PWSCalendarView %f",frame.size.height);
...
- (float) GetDataHeadViewHeight
{
    ...
    {
        rt = PWSCalendarSeperateLineHeight+PWSCalendarWeekDaysHeight;
    }
    return rt;
}
...
- (void) SetCollectionView
{
    ...
    m_view_calendar.backgroundColor=[UIColor clearColor];
